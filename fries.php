                        ...
                        <div class="row">
                                ...
                                <div class="menu-2">
                                        ...
                                        <ul class="menu-pane-2 wow bounceInLeft">
                                            ...
                                            <li  class="sel"><img src="images/fries-32.png"><a href="fries.php">Fries</a></li>
...
$results = $mysqli_conn->query("SELECT product_name, product_desc, product_code, product_image, product_price FROM products_list where product_desc='fries'");
...
<div><img src="images/fries/{$row["product_image"]}" height="260px" width="260px"></div>
