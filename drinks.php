                        ...
                        <div class="row">
                                ...
                                <div class="menu-2">
                                        ...
                                        <ul class="menu-pane-2 wow bounceInLeft">
                                            ...
                                            <li class="sel"><img src="images/pint-32.png"><a href="drinks.php">Drinks</a></li>
                                        </ul>
                                </div>
                                </div>
                        </div>
...
$results = $mysqli_conn->query("SELECT product_name, product_desc, product_code, product_image, product_price FROM products_list where product_desc='drinks'");
...
<div><img src="images/drinks/{$row["product_image"]}" height="260px" width="260px"></div>
   ...
   <select name="product_qty">
	<option value="1">1</option>
        ...
        <option value="5">5</option>
         ...
         <select style="visibility:hidden;" name="product_size">
