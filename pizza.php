...
<li class="sel"><img src="images/pizza-32.png"><a href="pizza.php">Pizza</a></li>
...
$results = $mysqli_conn->query("SELECT product_name, product_desc, product_code, product_image, product_price FROM products_list where product_desc='pizza'");
...
<div><img src="images/pizza/{$row["product_image"]}" height="260px" width="260px"></div>
...
<button id="cartSubmit "class="btn btn-default" type="submit">Add to Cart</button>
</div>
</div>  
</form>
</div>
